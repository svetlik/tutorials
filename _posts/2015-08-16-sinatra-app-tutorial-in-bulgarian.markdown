...
10. [Добавяне на layout](#app-view-layout)
11. [Показване на резултати](#app-vote-results)
12. [Реално отчитане на гласовете](#app-vote-counting)
13. [Трайно съхранение на гласовете](#app-yaml-persistence)
14. [Допълнителни задачи](#app-more) – [качване на приложението на Heroku](#heroku)
...
> **Инструктор:**
>
> Презентация, покриваща основните концепции от тази секция, [може да бъде видяна тук](https://speakerdeck.com/mitio/rails-girls-sofia-blitz-intro-to-programming).
