...
>
> Ако прецените, изтеглете [Notepad2](http://www.flos-freeware.ch/notepad2.html) ([директен линк, x86](http://www.flos-freeware.ch/zip/notepad2_4.2.25_x86.zip)), за да е цветен HTML-ът, който ще показвате тук, ако планирате да го правите на лаптопа на участничките, а не в Cloud9.
>
