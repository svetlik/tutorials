...
Първо се налага да инсталираме библиотеката Sinatra, която ще използваме:
...
> **Инструктор:**
>
> Обяснете за това как се стартират Ruby програми и припомнете, че `ruby` е програма-интерпретатор. Говорете за команди и терминал, ако е необходимо.
>
