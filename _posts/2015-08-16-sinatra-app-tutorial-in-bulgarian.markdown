...
> **Инструктор:**
>
> Обяснете разликата между обикновен текстов файл и Word документ. Влезте с участничките в Nitrous и разяснете основните компоненти там, без да навлизате в твърде много детайли – къде стоят файловете, къде е този сървър. За command line ще стане дума по-късно. Обяснете какво всъщност замества тази услуга – редактор, терминал/конзола, файлова система, стартиране на процеси. Ако прецените, изтеглете [Notepad2](http://www.flos-freeware.ch/notepad2.html) ([директен линк, x86](http://www.flos-freeware.ch/zip/notepad2_4.2.25_x86.zip)), за да е цветен HTML-ът, който ще показвате в следващата секция.
...
Обърнете внимание, че prompt-ът (символите отляво на курсора) ще се смени до този на `irb`. За да ви е по-удобно, може да увеличите размера на панела с конзолата.
