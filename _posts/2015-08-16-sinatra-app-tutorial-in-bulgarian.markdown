...
За целта, трябва да направим папка, в която ще слагаме тези HTML файлове. Папката трябва да се казва `views` (логично, нали?)
...
Проверете дали всичко е наред, като спрете и пуснете отново вашето приложение с `ruby voter.rb -o 0.0.0.0`. Знаете ли, че в терминала имате история на последно изпълнените команди? Стрелките нагоре и надолу ви движат по тази история, когато в момента няма работеща команда там.
